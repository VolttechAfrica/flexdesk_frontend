...
import { ROLE_ROUTES, UserRole, User as UserType } from "@/lib/types/auth"
...
export default function StaffOnboardingPage({ user, logout }: StaffOnboardingPageProps) {
  ...
  const handleSubmit = useCallback(async () => {
    try {
      const response = await apiClient.post("/onboarding/staff", formData)
